...
export const GET_PRODUCT_SC = "GET_PRODUCT_SC";
export const GET_PRODUCT_ER = "GET_PRODUCT_ER";
...
export const GET_DISCOUNT_SC = "GET_DISCOUNT_SC";
export const GET_DISCOUNT_ER = "GET_DISCOUNT_ER";

export const EDIT_DISCOUNT = "EDIT_DISCOUNT";
export const EDIT_DISCOUNT_ER = "EDIT_DISCOUNT_ER";
